...
public class MiniBoss : Enemy
{
	...
	public MiniBoss(string name, int level, bool phys, bool range, bool alternateDmg, Coordinate pos, TargetPriority priority) :
		this(name, level, phys, range, alternateDmg, pos, 25, 0.1f, 0.5f, 1.0f, 250, 20, 20, 10, 10, 10, 10, 10, 10, 10, 2, 2, priority)
	{
	}
	public MiniBoss() : this("Basic Enemy", 1, true, false, false, new(0, 0), TargetPriority.Closest) { }
